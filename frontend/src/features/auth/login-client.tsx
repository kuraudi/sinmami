    ...
    <div className="subtle-grid noise-overlay min-h-dvh flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="rounded-3xl border border-white/60 bg-white/80 p-8 shadow-xl backdrop-blur-xl">
          <h1 className="font-editorial text-3xl text-foreground mb-1">Вход</h1>
          <p className="text-sm text-(--muted) mb-7">Войдите чтобы видеть историю договоров</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            >
              {status === "loading" ? (
                <><span className="h-3.5 w-3.5 animate-spin rounded-full border-2 border-white/30 border-t-white" />Входим...</>
              ) : (
